#!/usr/bin/env python3
"""
This tool finds ONT reads which match expectations for TraDIS sequencing, and it output those reads
trimmed down to their genomic sequence. It has one external requirement: minimap2.
